...
class PlanificarViajeSerializer(serializers.Serializer):
    ...
    def validate_rango_fechas(self, value):
        ...
        if len(patron_fechas) != 2:
            raise ValidationError("El rango de fechas debe contener exactamente dos fechas válidas en formato AAAA-MM-DD.")
        ...
        try:
            ...
            raise ValidationError("Las fechas proporcionadas no existen en el calendario.")
